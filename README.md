...
- 🔭 I’m currently working on:
  ...
  - [norman](https://github.com/h5law/norman). A zero-dependency `libc` implementation and expanded C standard library. Part of the `aion` umbrella.
  - [ndjin](https://github.com/h5law/ndjin). A chess engine (bot and game driver), as well as GUI client written from scratch.
